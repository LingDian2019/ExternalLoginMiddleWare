...
namespace Authentication_Test.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            else if (info.LoginProvider.Equals("WXWork",StringComparison.InvariantCultureIgnoreCase))
            {
            ...
            else if (info.LoginProvider.Equals("DingTalk", StringComparison.InvariantCultureIgnoreCase))
            {
                var loginInfo = await HttpContext.GetExternalDingTalkLoginInfoAsync();
